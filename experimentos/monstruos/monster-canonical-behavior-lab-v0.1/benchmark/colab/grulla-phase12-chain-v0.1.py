# Grulla Blanca — cadena Fase I -> Fase II v0.1
...
def main():
    ...
    df.to_csv("grulla_phase12_chain_v0.1.csv",index=False)
    summary.to_csv("grulla_phase12_chain_summary_v0.1.csv",index=False)
    roots.to_csv("grulla_phase12_chain_roots_v0.1.csv",index=False)
